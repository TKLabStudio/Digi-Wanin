(function () {
    ...
    class HulkBuster extends IronMan {
        constructor(name) {
            super(name);
            this.m_Name = "Dr." + name;
        }
    ...
    class Main {
        ...
        onConfigLoaded() {
            ...
            let n = null;
            let anArray = ["a", 1];
            let aStringArray = ["a", "c", "s", "f", "g"];
            let aNumberArray = [1, 2, 3, 4, 5];
            let aNumber = aNumberArray[0];
            aNumberArray.forEach((aNumber) => {
                console.log(aNumber);
            });
        ...
        printName(surname, title = "Mr.") {
            console.log("hi" + title + surname);
        }
        printFamily(father, mother, ...chilren) {
            console.log(father);
            console.log(mother);
            if (chilren) {
